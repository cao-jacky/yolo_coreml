...
class ViewController: UIViewController {
  ...
  func setUpCamera() {
    ...
    videoCapture.fps = 60
    videoCapture.setUp(sessionPreset: AVCaptureSession.Preset.hd4K3840x2160) { success in
      if success {
  ...
  func showOnMainThread(_ boundingBoxes: [YOLO.Prediction], _ elapsed: CFTimeInterval) {
    DispatchQueue.main.async {
      ...
      self.timeLabel.text = String(format: "Processing time %.5f seconds - %.2f FPS", elapsed, fps)
